---
title: "EXAMEN MÓDULO 1 - DATA SCIENCE Y BIG DATA. LA NUEVA REALIDAD"
...
Eliminamos la variable DoctorInCharge ya que no forma parte de las variables objeto de estudio (segun el enunciado) y volvemos a comprobar los datos:
```{r}
df <- df %>% select(-DoctorInCharge)
formattable(head(df))
```
